...
Use structured logging that integrates with Playwright's test reports. Support
object logging, test step decoration, and multiple log levels (info, step,
...
**Context**: Organize test execution into collapsible steps for better
...
import { captureTestContext, log } from '@seontechnologies/playwright-utils';
