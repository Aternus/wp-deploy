...
Combine multiple Playwright fixtures using `mergeTests` to create a unified test
object with all capabilities. Build composable test infrastructure by merging
playwright-utils fixtures with custom project fixtures.
...
**Context**: Production setup with all core playwright-utils and custom
fixtures.
...
import { test as fixture1, test as fixture1 } from './fixture1'; // has 'user' fixture
...
- `network-recorder.md`, `intercept-network-call.md`, `log.md` - Additional
  utilities
