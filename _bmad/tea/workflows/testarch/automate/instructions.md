...
**Workflow ID**: `_bmad/tea/testarch/automate` **Version**: 5.0 (Step-File
Architecture)
...
Expands test automation coverage by generating prioritized tests at the
appropriate level (E2E, API, Component, Unit) with supporting fixtures and
helpers.
