...
This is an **isolated subagent** running in parallel with other quality
dimension checks.
...
- ❌ Do NOT check isolation, maintainability, coverage, or performance (other
  subagents)
...
**Subagent terminates here.** Parent workflow will read output and aggregate
