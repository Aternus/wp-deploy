...
To identify what the user wants to edit in the teach-me-testing workflow and
gather requirements for the modifications.
...
✅ Edit requirements clearly understood, target files identified, edit plan
documented, user approves plan.
