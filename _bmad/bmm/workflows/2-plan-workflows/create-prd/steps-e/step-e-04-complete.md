...
description:
  'Complete & Validate - Present options for next steps including full
  validation'
...
Present summary of completed edits and offer next steps including seamless
...
**[V] Run Full Validation** - Execute complete validation workflow (steps-v) to
verify PRD quality **[E] Edit More** - Make additional edits to the PRD **[S]
Summary** - End with detailed summary of changes **[X] Exit** - Exit edit
workflow
...
- **IF V (Run Full Validation):**
  ...
  - Note: This hands off to the validation workflow which will run its complete
    13-step process
...
**Master Rule:** Edit workflow seamlessly integrates with validation. User can
edit → validate → edit again → validate again in iterative improvement cycle.
