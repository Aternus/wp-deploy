...
tsdown integrates with [publint](https://publint.dev/) and
[Are the types wrong?](https://arethetypeswrong.github.io/) (attw) to catch
common packaging issues. Both are optional dependencies.
...
Checks that `package.json` fields (`exports`, `main`, `module`, `types`) match
...
Verifies TypeScript declarations are correct across different module resolution
strategies (`node10`, `node16`, `bundler`).
